...
export const updateProduct = async (req, res) => {
    ...
    try {
        const prod = await Product.findByIdAndUpdate({ _id }, {
            name: req?.body?.name,
...
export const addReview = async (req, res) => {
    ...
    const isReviewAlreadyAdded = product?.reviews.some((review) => JSON.stringify(review.userId) == JSON.stringify(req.user?._id));
...
export const updateReview = async (req, res) => {
    const _id = req.params.id;
    try {
        await Product.findOneAndUpdate({ 'reviews._id': _id }, {
            $set: {
